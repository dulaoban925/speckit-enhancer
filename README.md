...
│   │   ├── services/   # 服务层 (CLI Service, Markdown Service, Comment Service)
│   │   ├── hooks/      # 自定义 Hooks (useProject, useDocuments, useComments, useTextSelection)
│   │   ├── store/      # Zustand 状态管理
...
- [任务列表](./specs/001-speckit-ui-viewer/tasks.md) - 详细的实施任务和进度
- [实现总结](./specs/001-speckit-ui-viewer/implementation-summary.md) - Phase 6 评论系统实现总结
- [V2.0 设计文档](./specs/001-speckit-ui-viewer/design-comment-markers-v2.md) - 评论标记技术设计
